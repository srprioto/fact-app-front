                ...
                <div className="wrap-descripcion3">
                    ...
                    <div className="grid-2 gap">
                        ...
                        <div className="box-wrap-descripcion3">
                            ...
                            <span>
                                <p>Monto apertura:</p>
                                <h4 className="info-i">S/. { itemCaja.monto_apertura }</h4>
                            </span>
                            ...
                            <span>
                                ...
                                <h4 className={
                                    ...
                                    ? "danger-i"
                                    : "success-i")
                                }>S/. { itemCaja.monto_cierre }</h4>
                            </span>

                            <span>
                                <p className="strong">Monto total:</p>
                                <h2 className="success-i strong">S/. { 
                                    itemCaja.monto_cierre + 
                                    itemCaja.monto_apertura + 
                                    itemCaja.otros_montos
                                }</h2>
                            </span>
