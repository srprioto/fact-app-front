    ...
    return (
        <div className="producto-barras center">
            <div className="wrap-barcode pt-10">
                { producto.nombre && <h4 className="m-0">{ producto.nombre }</h4> }
                <div className={
                    "gap " + 
                    ...
                    { producto.color && <h5 className="m-0">Color: <strong>{ producto.color }</strong></h5> }
                    { producto.talla && <h5 className="m-0">Talla: <strong>{ producto.talla }</strong></h5> }
                </div>
                <Barcode
